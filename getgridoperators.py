names = [
    ...
    "Grid System Operator (GSO)",              # Real‑time grid system operator (ring‑fenced entity within TNB) :contentReference[oaicite:1]{index=1}
    ...
    "Nepal Electricity Authority (NEA)",            # National utility responsible for generation, transmission, and distribution of electricity across Nepal 🇳🇵:contentReference[oaicite:0]{index=0}
    "Rastriya Prasaran Grid Company Limited (RPGCL)", # Government‑established transmission grid company (grid owner & system operator)🇳🇵:contentReference[oaicite:1]{index=1}
